...
function c60620005.condition(e,tp,eg,ep,ev,re,r,rp)
	return rp==1-tp and re:IsHasType(EFFECT_TYPE_ACTIVATE) and Duel.IsChainNegatable(ev) and Duel.GetMatchingGroupCount(c60620005.cfilter,tp,LOCATION_HAND,0,nil)>0
end
...
function c60620005.activate(e,tp,eg,ep,ev,re,r,rp)
	...
	if Duel.GetMatchingGroupCount(c60620005.cfilter,tp,LOCATION_HAND,0,nil)>0 then
