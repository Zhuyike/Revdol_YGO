...
function c170014.e2op(e,tp,eg,ep,ev,re,r,rp)
	...
	local g=Duel.SelectMatchingCard(tp,aux.NecroValleyFilter(c170014.filter2),tp,0x13,0,1,1,nil,e,tp)
...
function c170014.e2tg(e,tp,eg,ep,ev,re,r,rp,chk)
	if chk==0 then return Duel.GetLocationCount(tp,LOCATION_MZONE)>0
		and Duel.IsExistingMatchingCard(c170014.filter2,tp,0x13,0,1,nil,e,tp) end
