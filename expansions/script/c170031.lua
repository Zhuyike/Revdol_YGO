...
function c170031.initial_effect(c)
	...
	e3:SetDescription(aux.Stringid(170031,0))
	...
	e4:SetDescription(aux.Stringid(170031,1))
...
function c170031.poscon(e,tp,eg,ep,ev,re,r,rp)
	...
	return  c:IsReason(REASON_DESTROY) and (c:IsReason(REASON_DESTROY) and rp==1-tp or c:IsReason(REASON_BATTLE) and c==Duel.GetAttackTarget())
end
