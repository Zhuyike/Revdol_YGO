...
function c170001.atkop(e,tp,eg,ep,ev,re,r,rp)
	local c=e:GetHandler()
	if not c:IsRelateToEffect(e) then return end
	local g=Duel.GetMatchingGroup(c170001.changefilter,c:GetControler(),LOCATION_MZONE+LOCATION_GRAVE,0,c)
	local g2=Duel.GetMatchingGroup(c170001.changefilter,1-c:GetControler(),LOCATION_MZONE+LOCATION_GRAVE,0,c)
